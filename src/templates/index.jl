      ...
      div(class="grid") do
        ...
        main() do
          section(class="notes-index") do
            p("Hello! I'm a computer scientist studying artificial intelligence. Here you will find a collection of personal notes I've been compiling on all sorts of cool topics.")
